...
<div class="card">
  <div class="card-header d-flex align-items-center justify-content-between">
    <h5 class="mb-0"><i class="ti ti-user-plus me-2"></i>Enroll Requests</h5>
    ...
    <table class="table table-hover align-middle">
      ...
      @forelse($requests as $r)
        <tr>
          ...
          <td class="text-end">
            <a class="btn btn-sm btn-primary" href="{{ route('admin.enroll-requests.show',$r) }}">
              <i class="ti ti-eye me-1"></i> Review
            </a>
          </td>
        </tr>
      @empty
        <tr><td colspan="6" class="text-center text-muted py-4">No enroll requests.</td></tr>
      @endforelse
      </tbody>
    </table>
