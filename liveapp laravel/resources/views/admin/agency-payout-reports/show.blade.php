...
<div class="admin-page-shell">
  ...
  <section class="row g-3 mb-3">
    ...
    <div class="col-md-6 col-xl-3"><div class="card"><div class="card-body"><small class="text-muted">PK Events</small><div class="fs-5 fw-semibold mt-1">{{ number_format($report->total_pk_event_count) }}</div></div></div></div>
