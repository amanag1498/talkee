              ...
              <td class="text-end">
                <div class="d-inline-flex flex-wrap justify-content-end gap-1">
                  ...
                  @if($report->status !== 'paid')
                    <form method="post" action="{{ route('admin.agency-payout-reports.destroy', $report) }}" class="d-inline" onsubmit="return confirm('Delete this payout report draft? This cannot be undone.');">
                      @csrf
                      @method('DELETE')
