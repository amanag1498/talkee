      ...
      <div class="policy-content">
        <div class="content-card">
          <p class="policy-copy">
            ...
            that hyperlink to this Policy and are available through the Apple App Store and Google Play Store.
          </p>
          <p class="policy-copy">
            This Privacy Policy is part of, and is governed by, the terms and conditions set forth in our Terms of Service located at
            <a href="{{ route('terms-of-service') }}">{{ route('terms-of-service') }}</a>. Please read the Terms of Service carefully before you use our Services.
          </p>
          ...
          <p><strong>A. Registration Information and Profiles.</strong> Talkieo allows you to use a supported identity provider, including Google or Apple, to register and create an account. We may collect the information you provide or authorize that provider to share, such as your name, email address, profile picture, provider identifier, and email-verification state.</p>
          <p><strong>B. Device and notification information.</strong> We may collect information that your mobile device sends when using a Product, such as its operating system, language, app installation or device identifier, push-notification token, IP address, logs, and use of the Product.</p>
          ...
          <p><strong>I. Purchase information.</strong> Apple processes iOS in-app payments and Google Play or our payment provider may process supported Android payments. Talkieo receives transaction identifiers, product identifiers, price/currency information, transaction status, and refund or revocation status needed to verify purchases and maintain the wallet ledger. Talkieo does not receive your full payment-card details from Apple.</p>
          <p>
          ...
          <p>
            If you think there has been unauthorized access to or use of your account, please contact us immediately at <a href="mailto:admin@talkee.in">admin@talkee.in</a>.
          </p>
          ...
          <p>
            You may reach our Data Protection Officer at <a href="mailto:admin@talkee.in">admin@talkee.in</a>.
          </p>
