...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Use these values when running queue workers to enforce consistent retry
    | and timeout behavior across environments.
    |
    */
    'worker' => [
        ...
        'max_jobs' => (int) env('QUEUE_WORKER_MAX_JOBS', 1000),
    ],
